...
# Run like so
# ./config/run.sh --report_path /foox --initial_url https://foo.com/ --scan_timeout 160 --license_path ./config/license.txt   
...
MOLLY_CONFIG=./config/burp_molly_config.json
BURP_JAR_PATH=./config/burpsuite_pro.jar
USER_CONFIG=./config/burp_user_config.json
PROJECT_CONFIG=./config/scan_policy.json
...
# Run burp using expect for license management
